...
const navItems: NavItem[] = [
  ...
  icon: <BoxCubeIcon />,
  name: "Design",
  // Remove `path` if this is just a parent item
  subItems: [
    { name: "Texture", path: "/design/texture" },
    { name: "Color", path: "/design/color" },
    { name: "Category", path: "/design/category" },
    { name: "Product", path: "/design/product" },
    { name: "Shop", path: "/design/shop" },
  ],
},
];
